...
import static com.mycompany.app.domain.CustomerDetailsAsserts.*;
...
import com.mycompany.app.domain.enumeration.Gender;
...
class CustomerDetailsResourceIT {
    ...
    void partialUpdateCustomerDetailsWithPatch() throws Exception {
        ...
        partialUpdatedCustomerDetails.country(UPDATED_COUNTRY);
